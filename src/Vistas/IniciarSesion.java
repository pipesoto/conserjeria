...
String tipo_permiso_usuario;
    try{
       ...
       tipo_permiso_usuario =rs.getString("permisos");
       ...
       switch(tipo_permiso_usuario){
           ...
           case "conserje":
           PanelTrabajadores formConserje  =new PanelTrabajadores();
            formConserje.setVisible(true);
            this.dispose();
           break;
       ...
       JOptionPane.showMessageDialog(null, "Error,Ingrese sus datos nuevamente");
       }
